document.addEventListener("DOMContentLoaded", function() {
  ...
  floatingPicContainer.addEventListener('click', function() {
      ...
      // Astronaut animation code remains unchanged
      astronauts.forEach((astronaut, index) => {
          ...
          if (index === 0) { //1st astronaut = bottom to top
              ...
              astronaut.style.transform = 'rotate(' + randomRotate + 'deg)';
              setTimeout(() => {
                  astronaut.style.transitionDuration = '20s'; // longer animation time
          ...
          // removes astronaut when it finishes its spacewalk. dont worry no astronaut was harmed  in the making of this website!
